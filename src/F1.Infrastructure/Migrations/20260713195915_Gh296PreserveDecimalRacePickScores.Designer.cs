...
namespace F1.Infrastructure.Migrations
{
    ...
    [Migration("20260713195915_Gh296PreserveDecimalRacePickScores")]
    partial class Gh296PreserveDecimalRacePickScores
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("F1.Infrastructure.Data.Entities.MigrationImportRawRowEntity", b =>
                {
                    ...
                    b.HasIndex("ImportRunId", "SourceFileName", "RowNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("F1.Infrastructure.Data.Entities.QuestionScoreEntity", b =>
                {
                    ...
                    b.Property<Guid?>("OverrideSourceRunId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OverrideSourceRunId");
            ...
            modelBuilder.Entity("F1.Infrastructure.Data.Entities.RacePickScoreEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("RaceId", "ParticipantId");

                    b.HasIndex("RaceId", "PickType", "ParticipantId")
                        .IsUnique();

                    b.ToTable("RacePickScores", (string)null);
                });
